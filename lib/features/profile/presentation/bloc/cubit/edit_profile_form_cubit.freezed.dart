...
class _$EditProfileFormStateImpl implements _EditProfileFormState {
  ...
  @override
  String toString() {
    return 'EditProfileFormState(nameValid: $nameValid, emailValid: $emailValid, birthDateValid: $birthDateValid, validForm: $validForm, acceptLoyality: $acceptLoyality)';
  }
...
abstract class _EditProfileFormState implements EditProfileFormState {
  const factory _EditProfileFormState(
      ...
      final bool birthDateValid,
      final bool validForm,
      final bool acceptLoyality}) = _$EditProfileFormStateImpl;
