...
class _$SearchStateImpl implements _SearchState {
  const _$SearchStateImpl({final List<TagEntity> selectedTags = const []})
  ...
  @override
  String toString() {
    return 'SearchState(selectedTags: $selectedTags)';
  }
...
abstract class _SearchState implements SearchState {
  const factory _SearchState({final List<TagEntity> selectedTags}) =
      _$SearchStateImpl;
