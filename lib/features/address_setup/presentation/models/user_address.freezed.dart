...
class _$UserAddressImpl implements _UserAddress {
  ...
  @override
  String toString() {
    return 'UserAddress(city: $city, house: $house, street: $street, street2: $street2, flat: $flat, floor: $floor, entry: $entry, domofon: $domofon, comment: $comment, lat: $lat, lon: $lon)';
  }
...
abstract class _UserAddress implements UserAddress {
  const factory _UserAddress(
      ...
      final String? comment,
      final double? lat,
      final double? lon}) = _$UserAddressImpl;
