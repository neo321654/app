...
class _OrderApiService implements OrderApiService {
  ...
  Future<OrderCreateResponseDto> create(
    ...
    final _options = _setStreamType<OrderCreateResponseDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late OrderCreateResponseDto _value;
    try {
      _value = OrderCreateResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<List<OrderDto>> getOrders() async {
    ...
    final _options = _setStreamType<List<OrderDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<OrderDetailsDto> getOrder(int id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OrderDetailsDto>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<GiftsDto> gifts(OrderCreateRequestDto orderCreateRequestDto) async {
    ...
    final _data = <String, dynamic>{};
    _data.addAll(orderCreateRequestDto.toJson());
    final _options = _setStreamType<GiftsDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GiftsDto _value;
    try {
      _value = GiftsDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<List<GiftsScaleItemDto>> giftsScale() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<GiftsScaleItemDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<GiftsScaleItemDto> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
  ...
  Future<List<UpsalesDto>> upsale(UpsaleRequestDto upsaleRequest) async {
    ...
    final _options = _setStreamType<List<UpsalesDto>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<BasketInfoDto> basketInfo(
    ...
    final _options = _setStreamType<BasketInfoDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BasketInfoDto _value;
    try {
      _value = BasketInfoDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<PaymentUrlDto> getPaymentUrl(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PaymentUrlDto>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PaymentUrlDto _value;
    try {
      _value = PaymentUrlDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
